...
#import numpy as np
#
#BASE_URL_MAP_SALUD = "http://localhost:8004"  # donde corre FastAPI
#
...
#            m2 = folium.Map(location=[results[0]["lat"], results[0]["lon"]], zoom_start=14)
#            folium.Marker(location=[lat, lng], tooltip="Tu clic", icon=folium.Icon(color="red")).add_to(m2)
#            for r in results:
#                folium.CircleMarker(location=[r["lat"], r["lon"]], radius=6, tooltip=f"{r['fna']} ({r['distance_km']:.3f} km)").add_to(m2)
